...
class InfoClient
{
     ...
     * @var integer
     *
     * @ORM\Column(name="id_info_client", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="NONE")
     */
    private $idInfoClient;
    
    /**
    * @var \Odysseus\FrontBundle\Entity\Client
    * @ORMOneToOne(targetEntity="Client")
    * @ORMJoinColumn(name="client_id", referencedColumnName="id_client")
    */
    private $client;
     ...
     * @return integer 
     */
    public function getIdInfoClient()
    {
        return $this->idInfoClient;
    }
